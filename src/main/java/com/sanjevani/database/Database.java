...
public class Database {   
    ...
    public static Community createCommunity(String name, String city, int zipcode, List<Integer> hospitalIds) {
        return communityList.put(lastCommunityId, new Community(lastCommunityId++, name, city, zipcode, hospitalIds));
    }
    ...
    public static Doctor createDoctor(String name, String userName, String password, int age, String gender, int communityId, List<Integer> hospitalIds) {
        Doctor doctor = new Doctor(lastPersonId++, name, userName, password, age, gender, communityId, hospitalIds);
    ...
    public static Patient createPatient(String name, String userName, String password, int age, String gender, int communityId) {
        Patient patient = new Patient(lastPersonId++, name, userName, password, age, gender, communityId);
        personList.put(lastPersonId, patient);
        return patient;
    }
    public static Person createAdmin(String name, String userName, String password, String role, int age, String gender, int communityId) {
        return personList.put(lastPersonId, new Person(lastPersonId++, name, userName, password, role, age, gender, communityId));
    }
    ...
    // House Data
    House house1 = createHouse(1, "Apartment-2001");
    House house2 = createHouse(2, "Apartment-301");
    
    // Community Data
    Community community1 = createCommunity("Jvue", "Boston", 02120, Arrays.asList(1,2));
    Community community2 = createCommunity("Mission Main", "Boston", 02120, Arrays.asList(1,2));
    ...
    // Doctor Data
    Doctor doctor1 = createDoctor("Dr. Rajeev Aggarwal", "rajeevAggarwal", "test@1234", 30, "Male", 1, Arrays.asList(1,2));
    Doctor doctor2 = createDoctor("Dr. Sunita Williams", "sunitawilliams", "test@1234", 25, "Female", 2, Arrays.asList(1,2));
    ...
    // Patient Data
    Patient patient1 = createPatient("Rajat Sharma", "rajatsharma", "test@1234", 30, "Male", 1);
    Patient patient2 = createPatient("Yash Pawar", "yashpawar", "test@1234", 25, "Male", 2);
    ...
    // Admin Data
    Person systemAdmin = createAdmin("Rajat Sharma", "rajatsharma", "test@1234", "SystemAdmin", 30, "Male", 1);
    Person communityAdmin = createAdmin("Yash Pawar", "rajatsharma", "test@1234", "CommunityAdmin", 30, "Male", 1);
    Person hospitalAdmin = createAdmin("Nitin Sharma", "rajatsharma", "test@1234", "HospitalAdmin", 30, "Male", 1);
}
